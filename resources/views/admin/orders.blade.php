                    ...
                    <li>
                        <div
                            ...
                            <table class="min-w-full text-sm text-left text-gray-700 dark:text-gray-200">
                                <thead
                                    class="text-xs text-gray-700 uppercase dark:text-gray-300 border-b dark:border-gray-600">
                                    <tr>
                                    ...
                                    <tr class="border-b dark:border-gray-600">
                                        ...
                                        <td class="px-4 py-3">
                                            @foreach ($order->items as $item)
                                                <div class="mb-2">
                                                    <div class="font-semibold">{{ $item->computer->name }}
                                                        (x{{ $item->quantity }})
                                                    </div>
                                        ...
                                        <td
                                            class="px-4 py-3 text-right text-green-600 dark:text-green-400 font-semibold whitespace-nowrap">
